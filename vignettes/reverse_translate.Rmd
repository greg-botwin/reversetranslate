...
An excellent source of protein amino acid sequences is the [UniProtKB/Swiss-Prot](https://www.uniprot.org/uniprot/?query=reviewed:yes). To reduce redundancy this UniProtKB reports a cannonical sequence based on the following criteria:
...
BiocManager::install("Biostrings", version = "3.8", quietly = TRUE, update = FALSE)
